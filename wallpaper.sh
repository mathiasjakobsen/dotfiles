...
i=$(( $RANDOM % 100 + 1 ))
/usr/local/bin/convert -size 1920x1080 -gravity center -background black -border 640x360 -bordercolor black -fill white -pointsize 42 -font Helvetica caption:"${WISDOM[i]//./.\n\n}" /Users/mathiasjakobsen/dotfiles/wisdom.png;
